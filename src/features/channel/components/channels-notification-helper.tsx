...
export const notificationProviders: ProviderIconTypes[] = [
    ...
    {value: "healthchecks", label: "Healthchecks.io", icon: HealthchecksIOIcon},
]
...
export function HealthchecksIOIcon(props: SVGProps<SVGSVGElement>) {
    return (
        <svg
        ...
        >
            <path
                fill="#5cb85f"
                d="m333.7 290-10.9-57.9h-76.4l47 279.9h72.3L390 367.6h71.7l8.2-77.6z"
            />
            <path
                fill="#33333f"
                d="M278.3 0H206l-48.1 286.3H53.8l-11.7 77.6h80l14.5 86.9h72.2L232 321.2l20.9-124.5 58.4-.1z"
            />
        </svg>
    );
}
    ...
    return (
        ...
        >
            <linearGradient
                ...
                gradientUnits="userSpaceOnUse"
            >
                <stop offset={0} stopColor="#144042"/>
                <stop offset={1} stopColor="#216666"/>
            </linearGradient>
            <ellipse cx={256} cy={256} rx={234.3} ry={239} fill="url(#apprise_svg__a)"/>
            <path
